...
static const variant_info_t aliothin_info = {
    ...
    .marketname = "Mi 11X",
    .model = "M2012K11AI",
    .build_fingerprint = "Mi/aliothin/aliothin:13/TKQ1.220829.002/V14.0.8.0.TKHMIXM:user/release-keys",
...
static const variant_info_t alioth_info = {
    ...
    .model = "M2012K11AC",
    .build_fingerprint = "Redmi/alioth/alioth:13/TKQ1.220829.002/V14.0.8.0.TKHMIXM:user/release-keys",
